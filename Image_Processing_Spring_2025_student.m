...
boardHoming = imread('Dice_6.jpeg');
...
% your real game)
Cropping_Permanent = [2315 2093 999 852];  
...
rbg_channel=boardHoming(:,:,1);
gbg_channel=boardHoming(:,:,2);
bbg_channel=boardHoming(:,:,3);
...
RGbg_Ratio = double(rbg_channel)./double(gbg_channel); %Red/Green Ratio
RBbg_Ratio = double(rbg_channel)./double(bbg_channel); %Red/Blue Ratio
GBbg_Ratio = double(gbg_channel)./double(bbg_channel); %Green/Blue Ratio
...
rdot_channel=Stickers_Filled(:,:,1);
gdot_channel=Stickers_Filled(:,:,2);
bdot_channel=Stickers_Filled(:,:,3);
RGdot_Ratio = double(rdot_channel)./double(gdot_channel); %Red/Green Ratio
RBdot_Ratio = double(rdot_channel)./double(bdot_channel); %Red/Blue Ratio
GBdot_Ratio = double(gdot_channel)./double(bdot_channel); %Green/Blue Ratio
